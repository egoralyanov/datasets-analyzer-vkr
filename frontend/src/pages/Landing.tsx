// Главная страница.
//
// Стиль: scientific/archive.
// - Sprint 5 Phase 3.3: серифный hero + статичный demo-«препарат» на Iris.
// - Sprint 6 Phase 6: гостевая часть переписана как feature-tour — hero +
//   витрина «Как это работает», построенная поверх реальной фикстуры
//   анализа Iris (см. frontend/src/demo/iris/). Каждый блок снабжён
//   подписью (DemoCallout), объясняющей функцию системы. §1-§4 рендерятся
//   существующими компонентами AnalysisResult, §5-§7 — статичные мини-
//   секции (промпт Phase 6: "не имитируем интерактив, не показываем
//   нерабочие кнопки").
//
// Авторизованный пользователь обслуживается отдельной веткой (Phase 3.4):
// hero сворачивается, вместо demo появляется dashboard.
